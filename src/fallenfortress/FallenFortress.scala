package fallenfortress

class FallenFortress {
  ...
  def menu: Unit = {
    scala.io.StdIn.readLine("This is the menu: \n\t" +
        "[1] Background\t [2] Very well") match {
      case "1" => println(new battlefight.StringFormatter(background).toString)
      case "2" => println("okay")
      case _ => println("hm..")
    }
  }
